...
public class GestureBuilderActivity extends ListActivity {
  ...
  private final File mStoreFile = new File(Environment.getExternalStorageDirectory(), "StylusKeyboardGestures");
  //private final String mStoreFileName = "StylusKeyboardGestures";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //gesturesFile !!
    SoftKeyboard.copyFile(this, R.raw.gestures, new File(Environment.getExternalStorageDirectory(), "StylusKeyboardGestures"));
    ...
    if (sStore == null) {
//            sStore = GestureLibraries.fromPrivateFile(this,mStoreFileName);
