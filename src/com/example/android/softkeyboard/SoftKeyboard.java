...
public class SoftKeyboard extends InputMethodService
        implements KeyboardView.OnKeyboardActionListener, GestureOverlayView.OnGesturePerformedListener {
    ...
    public void onCreate() {
        ...
        //gesturesFile !!
        copyFile(this, R.raw.gestures, new File(Environment.getExternalStorageDirectory(), "StylusKeyboardGestures"));
    }

    public static void copyFile(Context c, int resource, File outf) {
        //File outf = new File("/sdcard/parcdroid/marioriff.wav");
        if (!outf.exists()) {
            ...
            try {
                ...
                //System.out.println("Fout bij: contextheckOfSoundFileBestaat()");
                ex.printStackTrace();
            }
        }
    }
...
//        mInputView.setKeyboard(mQwertyKeyboard);
        ...
        mInputView = (LatinKeyboardView) gv.findViewById(R.id.keyboard);
        mInputView.setOnKeyboardActionListener(this);
        mInputView.setKeyboard(mQwertyKeyboard);
        ///loading of gestures is in onStartInput
    ...
    public boolean isTablet() {
        return Boolean.parseBoolean(getString(R.string.isTablet));
    }
    ...
    ///
        ...
        ///(RE)LOAD GESTURES
        mLibrary = GestureLibraries.fromFile(new File(Environment.getExternalStorageDirectory(), "StylusKeyboardGestures"));
        if (!mLibrary.load()) {
            Toast.makeText(this, "failed to load StylusKeyboardGestures!", 1).show();
            //finish();
        }
    }
    ...
    private void handleCharacter(int primaryCode, int[] keyCodes) {
        //Vibrate when key is touched
        //doVibrate(); //not here, does not work for del and enter.
        if (isInputViewShown()) {
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (predictions.size() > 0) {
            ...
            if (prediction.score > 1.0) {
                ...
                typeLetter(prediction.name);
                //Vibrate when entering symbol(s)
                doVibrate();
            }
        }
    }
